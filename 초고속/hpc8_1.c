...
main(int argc, char* argv[])
{
   ...
   block_lengths[0] = 10; block_lengths[1] = 1; block_lengths[2] = 1;
   ...
   typelist[0] = MPI_CHAR; typelist[1] = MPI_FLOAT; typelist[2] = MPI_INT;
